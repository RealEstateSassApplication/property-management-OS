...
func (f *fakeRepository) GetSettings(context.Context, string) (OrganizationSettings, error) {
...
func (f *fakeRepository) ListMembers(context.Context, string) ([]Member, error) {
	return f.members, nil
}
func (f *fakeRepository) GetMember(context.Context, string, string) (Member, error) {
	return f.member, nil
}
...
func (f *fakeRepository) RemoveMember(_ context.Context, _, userID string) error {
	f.removedUser = userID
	return nil
}
func (f *fakeRepository) CountAdmins(context.Context, string) (int, error) { return f.adminCount, nil }
func (f *fakeRepository) ListPortalLinks(context.Context, string) ([]PortalLink, error) {
	return nil, nil
}
...
func TestFinalAdminCannotBeDemoted(t *testing.T) {
	...
	if repo.updatedRole != "" {
		t.Fatalf("final admin role was mutated")
	}
}
...
func TestAdminCanBeDemotedWhenAnotherAdminExists(t *testing.T) {
	...
	if item.Role != "manager" || repo.updatedRole != "manager" {
		t.Fatalf("expected manager role, got %+v", item)
	}
}
...
func TestFinalAdminCannotBeRemoved(t *testing.T) {
	...
	if repo.removedUser != "" {
		t.Fatalf("final admin was removed")
	}
}
