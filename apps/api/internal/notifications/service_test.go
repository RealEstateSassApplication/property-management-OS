...
func (f *fakeRepository) GetRentReminderContext(context.Context, string, string) (RentReminderContext, error) { return f.reminder, nil }
func (f *fakeRepository) ClaimBatch(context.Context, string, int) ([]Notification, error) { return nil, nil }
func (f *fakeRepository) MarkDelivered(context.Context, string) error { return nil }
func (f *fakeRepository) MarkFailed(context.Context, string, string, time.Time, bool) error { return nil }
