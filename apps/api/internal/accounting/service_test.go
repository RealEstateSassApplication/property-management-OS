...
func (fakeRepository) ListRentAdjustments(context.Context, string) ([]RentAdjustment, error) { return nil, nil }
...
func (fakeRepository) ListPaymentReversals(context.Context, string) ([]PaymentReversal, error) { return nil, nil }
...
func (fakeRepository) ListDepositAccounts(context.Context, string) ([]DepositAccount, error) { return nil, nil }
...
func (fakeRepository) ListDepositTransactions(context.Context, string) ([]DepositTransaction, error) { return nil, nil }
...
func (fakeRepository) ListExpenses(context.Context, string) ([]PropertyExpense, error) { return nil, nil }
